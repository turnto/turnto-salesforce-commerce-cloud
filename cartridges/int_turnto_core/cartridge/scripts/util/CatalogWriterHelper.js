...
var CatalogWriterHelper = {
	 ...
	 * @return {HashMap} A Hash Map that maps a locale to a file writer for that locale
	 *
	 ...
	 */
	initializeFileWritersHashMap: function (allowedLocales) {
	...
	generateLocaleJson: function (product, imageUrl, priceStr, price, categoryPathJSON, bundledProductsArray, gtinHashMap, keywords) {
		//build locale JSON
		var localeJson = {
